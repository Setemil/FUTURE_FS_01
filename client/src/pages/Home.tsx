...
const featuredProjects = [
  {
    ...
    category: "Full-Stack",
    description:
      "Comprehensive e-commerce platform with admin dashboard, real-time analytics, and payment processing.",
  ...
  },
  {
    ...
    category: "Mobile App",
    description:
      "Cross-platform fitness tracking app with workout planning, progress tracking, and social features.",
  ...
  },
  {
    ...
    category: "AI/ML",
    description:
      "Intelligent chat assistant powered by OpenAI GPT-4 with custom training and conversation memory.",
    image: aiChatProject,
...
const recentProjects = [
  {
    ...
    category: "SaaS",
    description:
      "Project management tool with team collaboration, time tracking, and advanced reporting.",
...
export default function Home({ onProjectSelect }: HomeProps) {
  return (
    <div className="p-6 space-y-8">
      ...
      <section className="pb-[70px] space-y-4">
        <div className="flex items-center justify-between">
          <h2 className="text-xl font-semibold text-foreground">
